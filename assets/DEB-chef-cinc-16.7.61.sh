...
cp ~/chef-16.7.61/omnibus/pkg/chef*deb ~/
cp ~/chef-16.7.61/omnibus/pkg/chef*deb /tmp/
...
cp ~/cinc-full-16.7.61/cinc-16.7.61/omnibus/pkg/cinc*deb ~/
cp ~/cinc-full-16.7.61/cinc-16.7.61/omnibus/pkg/cinc*deb /tmp/
