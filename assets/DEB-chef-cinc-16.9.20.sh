...
cp ~/chef-16.9.20/omnibus/pkg/chef*deb ~/
cp ~/chef-16.9.20/omnibus/pkg/chef*deb /tmp/
...
cp ~/cinc-full-16.9.20/cinc-16.9.20/omnibus/pkg/cinc*deb ~/
cp ~/cinc-full-16.9.20/cinc-16.9.20/omnibus/pkg/cinc*deb /tmp/
