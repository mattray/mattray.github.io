...
cp ~/chef-16.10.8/omnibus/pkg/chef*rpm ~/
cp ~/chef-16.10.8/omnibus/pkg/chef*rpm /tmp/
...
cp ~/cinc-full-16.10.8/cinc-16.10.8/omnibus/pkg/cinc*rpm ~/
cp ~/cinc-full-16.10.8/cinc-16.10.8/omnibus/pkg/cinc*rpm /tmp/
