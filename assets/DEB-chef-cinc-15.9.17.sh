...
# Chef 15.9.17
cd
rm -rf ~/chef-15.9.17 ~/v15.9.17.tar.gz
sudo rm -rf /opt/chef
sudo mkdir /opt/chef
sudo chown omnibus:omnibus -R /opt/chef
wget https://github.com/chef/chef/archive/v15.9.17.tar.gz
tar -xzf v15.9.17.tar.gz
cd ~/chef-15.9.17/omnibus/
bundle install --without development --path=.bundle
bundle exec omnibus build chef -l internal
cp ~/chef-15.9.17/omnibus/pkg/chef*deb ~/
