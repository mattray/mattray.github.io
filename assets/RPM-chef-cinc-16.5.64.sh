...
cp ~/chef-16.5.64/omnibus/pkg/chef*rpm ~/
cp ~/chef-16.5.64/omnibus/pkg/chef*rpm /tmp/
...
cp ~/cinc-full-16.5.64/cinc-16.5.64/omnibus/pkg/cinc*rpm ~/
cp ~/cinc-full-16.5.64/cinc-16.5.64/omnibus/pkg/cinc*rpm /tmp/
