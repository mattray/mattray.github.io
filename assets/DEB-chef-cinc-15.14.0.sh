...
cp ~/chef-15.14.0/omnibus/pkg/chef*deb ~/
cp ~/chef-15.14.0/omnibus/pkg/chef*deb /tmp/
...
cp ~/cinc-full-15.14.0/cinc-15.14.0/omnibus/pkg/cinc*deb ~/
cp ~/cinc-full-15.14.0/cinc-15.14.0/omnibus/pkg/cinc*deb /tmp/
