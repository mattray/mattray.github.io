...
# Chef 15.8.23
cd
rm -rf ~/chef-15.8.23 ~/v15.8.23.tar.gz
sudo rm -rf /opt/chef
sudo mkdir /opt/chef
sudo chown omnibus:omnibus -R /opt/chef
wget https://github.com/chef/chef/archive/v15.8.23.tar.gz
tar -xzf v15.8.23.tar.gz
cd ~/chef-15.8.23/omnibus/
bundle install --without development --path=.bundle
bundle exec omnibus build chef -l internal
cp ~/chef-15.8.23/omnibus/pkg/chef*rpm ~/
...
cd cinc
tar -xzf ~/v15.8.23.tar.gz
mv ~/cinc/chef-15.8.23 ~/cinc/chef
# patch patch.sh
