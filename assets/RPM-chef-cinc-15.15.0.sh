...
cp ~/chef-15.15.0/omnibus/pkg/chef*rpm ~/
cp ~/chef-15.15.0/omnibus/pkg/chef*rpm /tmp/
...
cp ~/cinc-full-15.15.0/cinc-15.15.0/omnibus/pkg/cinc*rpm ~/
cp ~/cinc-full-15.15.0/cinc-15.15.0/omnibus/pkg/cinc*rpm /tmp/
