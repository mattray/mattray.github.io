...
cp ~/chef-16.8.14/omnibus/pkg/chef*deb ~/
cp ~/chef-16.8.14/omnibus/pkg/chef*deb /tmp/
...
cp ~/cinc-full-16.8.14/cinc-16.8.14/omnibus/pkg/cinc*deb ~/
cp ~/cinc-full-16.8.14/cinc-16.8.14/omnibus/pkg/cinc*deb /tmp/
