...
cp ~/chef-16.4.41/omnibus/pkg/chef*rpm ~/
cp ~/chef-16.4.41/omnibus/pkg/chef*rpm /tmp/
...
cp ~/cinc-full-16.4.41/cinc-16.4.41/omnibus/pkg/cinc*rpm ~/
cp ~/cinc-full-16.4.41/cinc-16.4.41/omnibus/pkg/cinc*rpm /tmp/
