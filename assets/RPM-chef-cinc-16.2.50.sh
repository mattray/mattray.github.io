...
# Chef 16.2.50
cd
rm -rf ~/chef-16.2.50 ~/v16.2.50.tar.gz
sudo rm -rf /opt/chef
sudo mkdir /opt/chef
sudo chown omnibus:omnibus -R /opt/chef
wget https://github.com/chef/chef/archive/v16.2.50.tar.gz
tar -xzf v16.2.50.tar.gz
cd ~/chef-16.2.50/omnibus/
bundle install --without development --path=.bundle
bundle exec omnibus build chef -l internal
cp ~/chef-16.2.50/omnibus/pkg/chef*rpm ~/
