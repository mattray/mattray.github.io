...
cp ~/chef-16.9.29/omnibus/pkg/chef*rpm ~/
cp ~/chef-16.9.29/omnibus/pkg/chef*rpm /tmp/
...
cp ~/cinc-full-16.9.29/cinc-16.9.29/omnibus/pkg/cinc*rpm ~/
cp ~/cinc-full-16.9.29/cinc-16.9.29/omnibus/pkg/cinc*rpm /tmp/
